...
<Carousel 
  ...
  <div className='flex justify-center items-center'>
    <img src={imageUrl1} alt="image3" className='w-full object-cover transition-transform duration-500 ease-in-out transform hover:scale-105' />
  </div>
  <div className='flex justify-center items-center'>
    <img src={imageUrl1} alt="image4" className='w-full object-cover transition-transform duration-500 ease-in-out transform hover:scale-105' />
  </div>
</Carousel>
  </div>
