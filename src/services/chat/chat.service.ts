...
export const chatApi = createApi({
    reducerPath : 'chatApi', // field name of Redux State
    ...
    endpoints : build => ({
        ...
        getMessages: build.query<MessageType[], { sender: number; recipient: number }>({
            query: ({ sender, recipient }) => `chat/between/${sender}/${recipient}`,
          }),
